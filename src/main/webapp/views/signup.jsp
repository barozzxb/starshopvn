    ...
    <div class="col-md-6 mx-auto">
        ...
        <form action="${pageContext.request.contextPath}/signup" method="post">
			...
			<div class="form-group mb-3">
				...
				<input type="password" class="form-control" id="c-password" placeholder="Confirm your Password" name="c-password" required>
			</div>
...
<script>
 ...
 // Thêm biến để kiểm tra thời gian gửi yêu cầu
    ...
    function suggestAddress() {
        ...
        if (address.length > 3 && (currentTime - lastRequestTime > 1100)) {
    ...
    function validateForm(event) {
        ...
        if (password !== confirmPassword) {
            ...
            if (!confirmPasswordError) {
                ...
                document.getElementById('c-password').parentNode.appendChild(confirmPasswordError);
            }
        } else {
            var confirmPasswordError = document.getElementById('confirm-password-error');
            if (confirmPasswordError) {
    ...
    function setMaxDate() {
        ...
        today = yyyy + '-' + mm + '-' + dd; // Định dạng lại ngày

        // Cập nhật giá trị max cho input type="date"
