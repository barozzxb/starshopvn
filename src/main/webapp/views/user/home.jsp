		...
		<div class="row justify-content-center align-items-center g-4">
			<c:forEach items="${topSelling}" var="prod">
				<div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
					...
					<a class="product-item" href="${pageContext.request.contextPath }/user/product/detail?pid=${prod.product.pid}"> 
					<img src="${imgUrl}" class="img-fluid product-thumbnail">
		            ...
		            <div class="col-12 col-md-3 mb-5 mb-md-0">
		                <div class="card shadow-sm border-light cdbg-light-green">
		                    <div class="card-body text-center">
		                        ...
		                        <a href="${pageContext.request.contextPath}/user/genre/products?gid=${genre.gid}" class="btn btn-primary">Xem chi tiết <i class="fa fa-arrow-right"></i></a>
		                    </div>
		                </div>
		            </div>
