					...
					<c:forEach var="order" items="${orders}">
						<tr>
							...
							<td><a href="${pageContext.request.contextPath}/user/order/detail?oid=${order.oid }"
								role="button" >
									Xem chi tiết </a></td>
<%-- 							<td><a data-bs-toggle="collapse" href="#order_${order.oid }" --%>
<!-- 								role="button" aria-expanded="false" aria-controls="info"> -->
<!-- 									Xem chi tiết </a></td> -->
						</tr>
...
<%-- 											<li class="list-group-item">${detail.product.pname} --%>
<%-- 												&emsp;- Số lượng: ${detail.dquantity} &emsp;- Đơn giá: <fmt:formatNumber --%>
<%-- 													value="${detail.product.pprice}" type="number" --%>
<%-- 													currencySymbol="" /> vnđ --%>
<!-- 											</li> -->
<%-- 										</c:forEach> --%>
<!-- 									</ul> -->
