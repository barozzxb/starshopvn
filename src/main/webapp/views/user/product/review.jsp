...
<body>
    <div class="container mt-4">
        ...
        <form action="${pageContext.request.contextPath}/user/product/review" 
            ...
            <div class="mb-3">
                <label for="mediaFile" class="form-label">Tệp đính kèm (hình ảnh/video):</label>
                <input type="file" name="mediaFile" id="mediaFile" class="form-control" accept="image/*,video/*">
            </div>
        ...
        <c:forEach var="review" items="${reviews}">
            <div class="card mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><strong>${review.account.name}</strong></span>
                    <span class="badge bg-warning text-dark">${review.rating} sao</span>
                </div>
                <div class="card-body">
                    <p>${review.comment}</p>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <img src="${pageContext.request.contextPath}${review.mediaUrl}" 
                                     alt="Hình ảnh đánh giá" class="img-fluid" style="max-width: 100%; height: auto;">
                            </c:otherwise>
                        </c:choose>
                    </c:if>
                </div>
                <div class="card-footer text-end">
                    ...
                    <a href="${pageContext.request.contextPath}/user/product/review/delete?reviewId=${review.reviewId}" 
