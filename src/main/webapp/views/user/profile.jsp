...
<div class="container centered-container">
	<div class="col-xs-6">
		<h3 class="text-center mb-4">Account infomation</h3>
		...
		<form action="${pageContext.request.contextPath}/user/profile" method="post">
			...
			<div class="form-group mb-3">
				<label for="email"><i class="fa fa-envelope"></i> Email</label> <input
					...
					placeholder="Enter your Email" name="email" value="${account.email }">
			</div>
			<div class="form-group mb-3">
				<label for="password"><i class="fa fa-lock"></i> Password</label> <input
					type="password" class="form-control" id="password"
					placeholder="Enter your Password" name="password" value="${account.password }">
			</div>
			<div class="form-group mb-3">
				<label for="phonenum"><i class="fa fa-user"></i> Phone number</label> <input
					type="text" class="form-control" id="phonenum"
					placeholder="Enter your phone number" name="phonenum" value="${account.phonenum }">
			</div>
			<div class="form-group mb-3">
