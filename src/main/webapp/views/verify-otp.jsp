...
function startTimer() {
    ...
    if (timerElement) {
        ...
        timerElement.textContent = `Resend OTP in ${timeLeft.toString()} seconds`;
        ...
        timer = setInterval(function() {
            ...
            timerElement.textContent = `Resend OTP in ${timeLeft.toString()} seconds`;  // Update the timer text content
